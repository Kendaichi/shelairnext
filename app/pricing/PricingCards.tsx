  ...
  return (
    <>
      ...
      >
        ...
        <motion.h1 custom={1} variants={fadeUp} className="text-4xl md:text-5xl font-extrabold mb-6">
          {pricingPage.heading}
        </motion.h1>
        <motion.p custom={2} variants={fadeUp} className="text-lg text-muted-foreground">
